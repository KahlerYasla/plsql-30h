...
alter table dependents drop primary key cascade;
...
alter table DEPARTMENTS
  add constraint FK_DEPARTMENT_LOCATIONSS foreign key (LOCATION_ID)
...
alter table EMPLOYEES
  add constraint FK_MANAGER foreign key (EMPLOYEE_ID)
...
alter table DEPENDENTS
  add constraint PK_DEPENDENTS primary key (DEPENDENT_ID);
alter table DEPENDENTS
  add constraint FK_DEPENDENTS_EMPLOYEES foreign key (EMPLOYEE_ID)
